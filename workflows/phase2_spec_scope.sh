...
run_phase "${1:?Usage: phase2_spec_scope.sh <project_name>}" "spec-scope-analyst" "Phase 2 - Spec scoping" "Identify Division 08 and Division 10 scope from the specification PDFs. Set frp_in_scope and div10_in_scope. Extract fire ratings and hardware-set callouts (page numbers only for HW groups). Record out-of-scope items you found without pricing them. Write extracted/scope_summary.json."
