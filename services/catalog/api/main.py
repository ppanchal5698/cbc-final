...
log = logs.configure("cbc.catalog.api")
...
async def lifespan(app: FastAPI):
    ...
    otel.configure("cbc.catalog.api")
    ...
    log.info("catalog api ready; storage at %s", settings.storage_root)
    sweep_task = None
    try:
        yield
    finally:
...
async def health() -> dict:
    ...
    return {
        ...
        # "the database is up" says nothing about whether a part can be found.
        # The split dropped this; only the catalog service can answer it.
