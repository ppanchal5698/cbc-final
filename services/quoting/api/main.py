...
log = logs.configure("cbc.quoting.api")
...
async def lifespan(app: FastAPI):
    ...
    otel.configure("cbc.quoting.api")
    ...
    log.info("quoting api ready; storage at %s", settings.storage_root)
    sweep_task = None
    try:
        yield
    finally:
