...
log = logs.configure("cbc.intake.api")
...
async def lifespan(app: FastAPI):
    ...
    log.info("intake api ready; storage at %s", settings.storage_root)
    sweep_task = None
    try:
        yield
    finally:
...
for router in (documents.router,
    versions.router,):
