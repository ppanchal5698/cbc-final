...
def main() -> int:
    ...
    if args.no_index:
        print("\nSkipped index_catalog jobs (--no-index). Run: python -m cbc.modules.catalog.api.pageindex.build --all")
        return 0
    ...
    print(
        ...
        "Or rebuild locally: python -m cbc.modules.catalog.api.pageindex.build --all"
    )
    return 0
